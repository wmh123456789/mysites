define([
  ...
  function(declare, lang, on, dom, domStyle, domClass, domConstruct, on, domQuery) {
  var toc = declare([], {
    ...
    hideTableOfContents: function(node, tocNode) {
      ...
      node.innerHTML = "<img src=\"../graphics/treenodeplus.gif\"> Show Table of Contents";
    ...
    showTableOfContents: function(node, tocNode) {
      ...
      node.innerHTML = "<img src=\"../graphics/tochide.gif\"> Hide Table of Contents"; 
    },
    ...
    highlightTopic: function() {
      ...
      if ( urlPieces[urlPieces.length - 2] === "jsapi" && 
           ...
           !urlPieces[urlPieces.length - 1].match("-amd") ) {
